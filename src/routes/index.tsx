...
function Studio() {
  ...
  return <div className="flex h-screen min-h-0 flex-col overflow-hidden bg-background">
    <header className="shrink-0 border-b border-border bg-surface"><CmykBar /><div className="flex flex-wrap items-center justify-between gap-3 px-6 py-4"><div className="flex items-baseline gap-4"><h1 className="font-display text-lg font-bold uppercase tracking-[0.18em] text-foreground">Imprima Cooper</h1><span className="text-sm uppercase tracking-[0.14em] text-muted-foreground">Gerador de Blocos</span></div><div className="flex items-center gap-3"><Btn onClick={() => newBlock(doc.typeId)}>Novo bloco</Btn><PdfExport /></div></div></header>
